"""
Real IQ Data — Gap Analysis Script (Linrad .raw format)
"""

import numpy as np


def load_iq_raw(filepath, header_bytes=41):
...
if __name__ == "__main__":
    ...
    print(f"Loading real IQ recording: {filepath}")
    I, Q = load_iq_raw(filepath)
    print(f"Sample rate: {sample_rate} Hz, Total samples: {len(I)}, Duration: {len(I)/sample_rate:.1f}s\n")

    print("=== Full-recording features ===")
